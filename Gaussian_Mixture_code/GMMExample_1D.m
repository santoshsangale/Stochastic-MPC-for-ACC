...
D2=load('Data2');
D3=load('Data3');
%d1_alpha_vp=sum(D1.alpha_vp)/length(D1.alpha_vp);
%d1_v_p_auswertung=sum(D1.v_p_auswertung)/length(D1.v_p_auswertung);
% d2_alpha_vp=sum(D2.alpha_vp)/length(D2.alpha_vp);
% d2_v_p_auswertung=sum(D2.v_p_auswertung)/length(D2.v_p_auswertung);
...
mu2=sum(D3.v_p_auswertung)/length(D3.v_p_auswertung);
sigma2=std(D3.v_p_auswertung);
m2=200;
